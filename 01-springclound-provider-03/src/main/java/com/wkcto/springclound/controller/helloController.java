...
@RequestMapping("/service/hello")
    ...
    System.out.println("Service 3 provider");
    return "Hello ,Spring Cloud!!~~~provider 33333333333";
}
    ...
    public User user() {
        ...
        System.out.println(" provider 3333  返回 user对象");
        return user;
    }
    ...
    public User  getuser(@RequestParam("id") Integer id,
        ...
        user.setName(name );
        user.setPhone(phone);
        System.out.println(" provider 33333  返回 user对象");
        return user;
    }
